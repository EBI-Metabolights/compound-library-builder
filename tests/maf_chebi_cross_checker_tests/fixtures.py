...
def good_dataframe():
    sample_data = {
        'database_identifier': ['CHEBI:12345']
    }
...
def chebi_complete_entity():
    response = MagicMock()
    response.text = "CHEBI:16449alanineAn alpha-amino acid that consists of propionic acid bearing an amino " \
...
@pytest.fixture
def overview():
    overview = chck.OverviewMetrics(total_studies=50, studies_processed=48, total_mafs=80, mafs_processed=78)
    yield overview
...
def compound_ids():
    ids = {
        'MTBLC1', 'MTBLC2', 'MTBLC3', 'MTBLC4', 'MTBLC5', 'MTBLC6'
    }
    compound_list = [
        'MTBLC3', 'MTBLC4', 'MTBLC5', 'MTBLC6', 'MTBLC7', 'MTBLC8', 'MTBLC9'
    ]
        ...
        'study':
            [
                ...
                },
                {
                    ...
                    "directory": False,
                    "file": "m_s_aureus_adaptation_to_different_human_cell_lines_metabolite_profiling_NMR_spectroscopy_v2_maf.tsv",
                    "status": "active",
