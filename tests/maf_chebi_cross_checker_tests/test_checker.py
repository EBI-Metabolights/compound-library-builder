...
from tests.maf_chebi_cross_checker_tests.fixtures import (
    checker_fixture,
    chebi_complete_entity,
...
class TestChecker:
    ...
    def test_go_bad_maf(
        self, checker_fixture, study_file_endpoint_fixture, good_dataframe
    ):
        ...
        checker_fixture.get_list_of_maf_files_in_study.return_value = [
            study_file_endpoint_fixture["study"][0]
        ]
    ...
    def test_get_list_of_maf_files_in_studies_good_resp(
        ...
        results = checker_fixture.get_list_of_maf_files_in_study(
            "MTBLS999999", overview
        )
        ...
        assert (
            "m_s_aureus_adaptation_to_different_human_cell_lines_metabolite_profiling_NMR_spectroscopy_v2_maf.tsv"
            in filenames
        )
    ...
    def test_save_report(self, mock_file, checker_fixture, registry, overview):
        ...
        checker_fixture.save_report(
            maf_registry=registry, db_registry=registry, overview=overview
        )
